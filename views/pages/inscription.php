        ...
        <div class="col-md-8  mt-4">
            ...
            <form id="form" class="row g-3 d-flex justify-content-center no-wrap m-2  bg-light needs-validation" novalidate action="inscription.php" method="post">
                ...
                <div class="col-md-6 input-control">
                    ...
                    <input type="text" class="form-control border-dark p-3" name="prenom" placeholder="prenom" id="prenom" required>
                ...
                <div class="col-md-6 input-control">
                    ...
                    <input type="password" class="form-control border-dark p-3" name="passwords" placeholder="password" id="passwords" required>
                ...
                <div class="col-md-6 input-control">
                    ...
                    <input type="password" class="form-control border-dark p-3" name="passwords" placeholder="password" id="passwords2" required>
                ...
                <div class="col-md-6 input-control">
                    ...
                    <select name="roles" class="form-select is-valid border-dark p-3" id="roles" required>
                        <option selected disabled value="">Choisir...</option>
                        <option value="administrateur" name='roles'>Administrateur</option>
                        <option value="utilisateur" name='roles'>Utilisateur</option>
                    </select>
